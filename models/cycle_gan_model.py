...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument("--load_GA", type=str, default=None,
                                help="path to generator A (to continue training)")
    ...
    def __init__(self, opt):
        ...
        if self.isTrain and hasattr(self.opt, "load_GA") and self.opt.load_GA:
            ...
            # import pdb
            # pdb.set_trace()
            model_dict = torch.load(self.opt.load_GA)
